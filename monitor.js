...
function renderLegend(){
	drawLegend(COLOR.MACHINE.TYPE_A,25,'其它');
	drawLegend(COLOR.MACHINE.TYPE_B,50,'2G网络');
	drawLegend(COLOR.MACHINE.TYPE_C,75,'3G网络');
	drawLegend(COLOR.MACHINE.TYPE_D,100,'4G网络');
	drawLegend(COLOR.MACHINE.TYPE_E,125,'5网络');
	//drawLegend(COLOR.MACHINE.TYPE_F,150,'F机型');
	//drawLegend(COLOR.MACHINE.TYPE_G,175,'5网络');
}
...
function renderLayer03Right(){
	drawLayer03Right($("#layer03_right_chart01 canvas").get(0),"#027825",0.306);
	drawLayer03Right($("#layer03_right_chart02 canvas").get(0),"#006DD6",0.567);
	drawLayer03Right($("#layer03_right_chart03 canvas").get(0),"#238681",0.127);
}
...
function drawLayer03Right(canvasObj,colorValue,rate){
	...
	ctx.fillText((rate*100).toFixed(1)+'%',circle.x-15,circle.y+10);
						...
						series : [
							{
								...
								data:[
									{value:35001, name:'其它'},
									{value:908, name:'2G网络'},
									{value:5401, name:'3G网络'},
									{value:187566, name:'4G网络'},
									{value:107263, name:'5G网络'}
									//{value:7600, name:'F机型'},
									//{value:107263, name:'5G网络'}
								]
							}
	...
	myChart.setOption({
			...
			series: [
						...
						},*/
						{
							...
							data:['',99.70994, 67.22689, 58.82353,'']
						}
					]
		}	
	);
